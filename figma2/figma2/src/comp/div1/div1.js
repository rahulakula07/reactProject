...
function Div1() {
  return (
    <div id="landing-page-Div">
      <div id="landing-left">
        <h1>
        Candy is a global branding and UX design agency
        </h1>
        <p>
        Elevate your online presence with Candy's expert design, development, and presentation services, bringing your project to fruition.
        </p>
